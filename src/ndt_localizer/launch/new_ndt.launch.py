...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('input_initial_pose_topic', default_value='/pose_with_covariance_stamped', description='Initial position topic to align'),
        ...
        DeclareLaunchArgument('step_size', default_value='0.4', description='The newton line search maximum step length'),
        DeclareLaunchArgument('resolution', default_value='5.0', description='The ND voxel grid resolution'),
        ...
        DeclareLaunchArgument('converged_param_transform_probability', default_value='8.0', description='Convergence probability parameter'),
        DeclareLaunchArgument('use_sim_time', default_value='false'),
        DeclareLaunchArgument('reinit_delay_duration', default_value='5.0'),
        ...
        Node(
            ...
            parameters=[
                ...
                {'reinit_delay_duration': LaunchConfiguration('reinit_delay_duration')},
